    ...
    while (escolha != 4) {
        ...
        if (escolha == 1) {
            ...
            if (dificuldade == 0) {
                ...
                for (int t = 1; t <= tentativas; ) { // Loop de tentativas
                    ...
                    if (qtd_digitos == 3) {//verfica se a tentativa esta nos parametros
                    ...
                    t++;//adiciona +1 na tentativa

                    int corretos_pos = 0;//variavel para contar os corretos na posição
                    ...
                    int corretos_fora = 0;
                    if (u1 != d1) {//conta os corretos fora da posição para as possibilidades
                    ...
                    cout << "Corretos na posição correta: " << corretos_pos << endl;//mostra as variaveis 
                    cout << "Corretos em posição errada: " << corretos_fora << endl;
                    cout << "Tentativas restantes: " << (tentativas - t + 1) << endl;

                    if (corretos_pos == qtd_digitos) {//verifica se o jogador acertou todos os digitos
                        cout << "\nVocê venceu!\n";
                        venceu = true;
                        break; // Sai do loop de tentativas
                    }
                }
                if (!venceu) {//se perder mostra que perdeu
            ...
            dificuldade = 0;
            while (dificuldade < 1 || dificuldade > 3) {//inicia o seletor de dificuldade e explica cada uma delas
